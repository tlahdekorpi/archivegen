...
var testMap = Map{
	...
	A: []Entry{
		{"name", "name", 0, 0, 0, TypeDirectory, "", 0, nil},
		{"disk", "archive", 0, 0, 0644, TypeRegular, "", 0, nil},
		{"dst", "dst", 0, 0, 0644, TypeCreate, "", 0, []byte("test		  test  \n")},
		{"nodata", "nodata", 0, 0, 0644, TypeCreate, "", 0, []byte{}},
		{"busybox", "sh", 0, 0, 0777, TypeSymlink, "", 0, nil},
		{"omit_test1", "omit_test1", 0, 0, 0644, TypeRegular, "", 0, nil},
		{"omit_test2", "omit_test2", 0, 0, 0644, TypeRegular, "", 0, nil},
		{"merge1", "merge1", 0, 0, 0755, TypeDirectory, "", 0, nil},
		{"merge2", "test", 0, 0, 0644, TypeRegular, "", 0, nil},
		{"testvar1", "testvar1", 0, 0, 0755, TypeDirectory, "", 0, nil},
		{"testvar2", "testvar2", 0, 0, 0755, TypeDirectory, "", 0, nil},
		{"$testvar1", "$testvar1", 0, 0, 0755, TypeDirectory, "", 0, nil},
		{"global1", "global1", 0, 0, 0755, TypeDirectory, "", 0, nil},
		{"global2", "global2", 0, 0, 0755, TypeDirectory, "", 0, nil},
		{"busybox", "foo", 0, 0, 0777, TypeSymlink, "", 0, nil},
		{"busybox", "bar", 0, 0, 0777, TypeSymlink, "", 0, nil},
		{"busybox", "baz", 0, 0, 0777, TypeSymlink, "", 0, nil},
		{"multi1", "multi1", 1, 2, 0755, TypeDirectory, "", 0, nil},
		{"multi2", "multi2", 1, 2, 0755, TypeDirectory, "", 0, nil},
		{"multi3", "multi3", 1, 2, 0755, TypeDirectory, "", 0, nil},
		{"../foo/bar", "symlinksrc/bar", 0, 0, 0777, TypeSymlink, "", 0, nil},
		{"../foo/baz", "symlinksrc/baz", 0, 0, 0777, TypeSymlink, "", 0, nil},
		{"multifile1", "multidst/multifile1", 0, 0, 0644, TypeRegular, "", 0, nil},
		{"multifile2", "multidst/multifile2", 0, 0, 0644, TypeRegular, "", 0, nil},
		{"multifile3", "multidst/multifile3", 0, 0, 0644, TypeRegular, "", 0, nil},
		{"heredoc", "heredoc", 0, 0, 0644, TypeCreate, "!heredoc", 0, []byte("test\\  data\n\n")},
		{"foo bar", "b az", 0, 0, 0644, TypeRegular, "", 0, nil},
		{"base64", "base64", 0, 0, 0644, TypeBase64, "", 0, []byte("YmFzZTY0")},
	},
